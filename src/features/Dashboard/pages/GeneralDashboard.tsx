  ...
  const renderNoTeamsSection = () => (
    <div className="text-center py-12 text-gray-500 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
      ...
      <p className="mb-6 text-sm max-w-md mx-auto">
        Create a new team or join an existing one to participate in tournaments
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-600">
          You're a member of {teams.length} team
          {teams.length !== 1 ? "s" : ""}
        </p>
  ...
  const renderOverviewSection = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-3">
        <SectionCard title="Available Tournaments" icon={<Trophy size={18} />}>
